How to scan images, lookup tables and time measurement with OpenCV {#tutorial_how_to_scan_roi}
==================================================================
...
](https://github.com/Itseez/opencv/tree/master/samples/cpp/tutorial_code/core/how_to_scan_roi/how_to_scan_roi.cpp) or look it up in
the samples directory of OpenCV at the cpp tutorial code for the core section. Its basic usage is:
@code{.bash}
how_to_scan_roi imageName.jpg intValueToReduce [G]
@endcode
...
@snippet how_to_scan_roi.cpp dividewith
...
@anchor tutorial_how_to_scan_roi_storing
...
@snippet how_to_scan_roi.cpp scan-c
...
@snippet how_to_scan_roi.cpp scan-iterator
...
@snippet how_to_scan_roi.cpp scan-random
...
@snippet how_to_scan_roi.cpp table-init

Finally call the function (I is our input image and J the output one):

@snippet how_to_scan_roi.cpp table-use
